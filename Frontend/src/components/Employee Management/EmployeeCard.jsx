      ...
      <Card sx={{ maxWidth: 485 }}>
        ...
        <CardContent>
          ...
          <Typography variant="body1" color="text.secondary">
            ...
            Salary :Rs.{employee.Salary}.00 <br />
            AllowancesType :{employee.AllowancesType} <br />
            AllowancesAmount :Rs.{employee.AllowancesAmount}.00 <br />
            OT Hours :{employee.OThours} <br />
            AmountPerHour :Rs.{employee.AmountPerHour}.00 <br />
            TotalSalary :Rs.{calculateTotalSalary()}.00 <br />
          </Typography>
        </CardContent>
        <CardActions>
