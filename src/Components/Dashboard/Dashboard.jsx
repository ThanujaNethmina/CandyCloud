...
import PrintableDashboardReport from '../PrintableDashboardReport/PrintableDashboardReport';
  ...
  return (
    <DashboardStyled>
      <InnerLayout>
        ...
        <button onClick={handlePrint} className="generate-report">Generate Report</button>
      </InnerLayout>
      <PrintableDashboardReport ref={componentRef} />
    </DashboardStyled>
  )
}
